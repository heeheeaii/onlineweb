...
public class DefaultExceptionHandlerConfig {
    ...
    @ExceptionHandler(OnlineWebException.class)
    public ResponseEntity<ServerResponseEntity<?>> unauthorizedExceptionHandler(OnlineWebException e){
        log.error("onlinewebExceptionHandler", e);
