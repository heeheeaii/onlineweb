...
import com.nu.shop.security.admin.dto.CaptchaAuthenticationDTO;
import com.nu.shop.security.common.bo.UserInfoInTokenBO;
import com.nu.shop.security.common.enums.SysTypeEnum;
import com.nu.shop.security.common.manager.PasswordCheckManager;
...
import com.nu.shop.sys.model.SysMenu;
import com.nu.shop.sys.model.SysUser;
import com.nu.shop.sys.service.SysMenuService;
...
public class AdminLoginController {
    ...
    public ServerResponseEntity<?> login(
        ...
        if (sysUser == null) {
            throw new OnlineWebException("账号或密码不正确");
        }
        ...
        if (Objects.equals(sysUser.getStatus(),0)) {
            // 未找到此用户信息
            throw new OnlineWebException("未找到此用户信息");
        }
