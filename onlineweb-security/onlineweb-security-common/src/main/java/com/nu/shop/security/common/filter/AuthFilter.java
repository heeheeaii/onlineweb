...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            // 手动捕获下非controller异常
            if (e instanceof OnlineWebException) {
                httpHandler.printServerResponseToWeb((OnlineWebException) e);
            } else {
                throw e;
            }
        } finally {
